                                                ...
                                                >
                                                    <span class="font-roboto"
                                                        ><span
                                                            ...
                                                            >T&#234;n homestay:
                                                            <strong
                                                                >{{$bill->order->first()->product->homestay->name}}</strong
                                                            ></span
                                                        ></span
                                                    >
                                                </p>
                                                                ...
                                                                ><span
                                                                    ...
                                                                    <em
                                                                        style="
                                                                            margin-top: 20px;
                                                                        "
                                                                        >{{$order->product->roomType->name}}</em
                                                                    >
                                                                    - </span
                                                                ><strong
                                                                    ><span
                                                                        style="
                                                                            ...
                                                                            color: #ff0000;
                                                                        "
                                                                        >{{ number_format( $order->product->prices*(100-$order->product->discount)/100,0,',','.' ) }}đ</span
                                                                    ></strong
                                                                ></span
                                                            >
                                                        </li>
                                                        ...
                                                        >
                                                            <span
                                                                ...
                                                                ><span
                                                                    ...
                                                                    nh&#7853;n
                                                                    ph&#242;ng:
                                                                    {{date( "d-m-Y", strtotime($bill->order->first()->date_start))}}</span
                                                                ></span
                                                            >
                                                        </li>
                                                        <li
                                                        ...
                                                        >
                                                            <span
                                                                ...
                                                                ><span
                                                                    ...
                                                                    tr&#7843;
                                                                    ph&#242;ng:
                                                                    {{date( "d-m-Y", strtotime($bill->order->first()->date_end))}}</span
                                                                ></span
                                                            >
                                                        </li>
                                                    </ol>
                                                            ...
                                                            ><span
                                                                ...
                                                                ><strong
                                                                    style="
                                                                        margin-top: 20px;
                                                                    "
                                                                    >{{ number_format( $bill->payments,0,',','.' ) }}đ</strong
                                                                ></span
                                                            ><span
                                                                style="
                                                                    color: #262626;
                                                            ...
                                                            <span
                                                                ...
                                                                ><span
                                                                    style="
                                                                        ...
                                                                        color: #262626;
                                                                    "
                                                                    >Tên: {{$bill->order->first()->product->homestay->user->name}}</span
                                                                ></span
                                                            >
                                                        </li>
                                                        <li
                                                        ...
                                                        >
                                                            <span
                                                                ...
                                                                ><span
                                                                    ...
                                                                    &#273;i&#7879;n
                                                                    tho&#7841;i:
                                                                    {{$bill->order->first()->product->homestay->user->phone}}</span
                                                                ></span
                                                            >
                                                        </li>
                                                        <li
                                                        ...
                                                        >
                                                            <span
                                                                ...
                                                                ><span
                                                                    ...
                                                                    "
                                                                    >Email:
                                                                    {{$bill->order->first()->product->homestay->user->email}}</span
                                                                ></span
                                                            >
                                                        </li>
                                                    </ol>
